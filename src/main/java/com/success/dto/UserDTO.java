...
public class UserDTO implements UserDetails{
	...
	public UserDTO(@NotBlank String password, @Email @NotBlank String userName, int concernId, String concerns,
			UserRole role, Boolean enabled, Boolean locked, UserAddress userAddress, UserInformation userInformation,
	...
	public boolean equals(Object obj) {
		...
		return concernId == other.concernId && Objects.equals(concerns, other.concerns)
				...
				&& Objects.equals(userInformation, other.userInformation) && Objects.equals(userName, other.userName);
	}
