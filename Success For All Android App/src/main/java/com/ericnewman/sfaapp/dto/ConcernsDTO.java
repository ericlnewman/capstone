...
public class ConcernsDTO {
    ...
    // two args constructor for name and description
    public ConcernsDTO(String concernsName, String concernDescription){
        this.concernsName = concernsName;
        this.concernDescription = concernDescription;
    }

    public ConcernsDTO(int id, String name, String concernCategory, String concernSubject, String topic, String concernDescription) {
        this.guid = id;
        this.concernsName = name;
        this.concernCategory = concernCategory;
        this.concernSubject = concernSubject;
        this.concernTopic = topic;
        this.concernDescription = concernDescription;
    }
    ...
    public String toString() {
        return "Concerns\n\nName:" + concernsName + "\nCategory:" + concernCategory
                + "\nSubject:" + concernSubject + "Description:" + concernDescription;
    }
