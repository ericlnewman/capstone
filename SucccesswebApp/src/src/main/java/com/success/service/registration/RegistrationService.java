...
import com.success.validatorandsecurity.email.EmailSender;
import com.success.validatorandsecurity.email.EmailValidator;
...
public class RegistrationService {
	...
	public String register(RegistrationRequest request) throws Exception {
	    ...
	    public String confirmToken(String token) throws MessagingException {
	        ...
	        userService.enableAccess(
	                confirmationToken.getUserDTO().getEmail());
	        String link = "http://localhost:8080/api/v/registration/confirm?token=" + token;
	        emailSender.send(
	                request.getEmail(),
